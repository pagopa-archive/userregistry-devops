variable "tlscert-dev-api-internal-dev-userregistry-pagopa-it" {
  default = {
    repository = {
      organization   = "pagopa"
...
module "tlscert-dev-api-internal-dev-userregistry-pagopa-it-cert_az" {
  ...
  repository                   = var.tlscert-dev-api-internal-dev-userregistry-pagopa-it.repository
  name                         = "${var.tlscert-dev-api-internal-dev-userregistry-pagopa-it.pipeline.dns_record_name}.${var.tlscert-dev-api-internal-dev-userregistry-pagopa-it.pipeline.dns_zone_name}"
  renew_token                  = local.tlscert_renew_token
  path                         = var.tlscert-dev-api-internal-dev-userregistry-pagopa-it.pipeline.path
  ...
  variables = merge(
    ...
    local.tlscert-dev-api-internal-dev-userregistry-pagopa-it-variables,
  )

  variables_secret = merge(
    var.tlscert-dev-api-internal-dev-userregistry-pagopa-it.pipeline.variables_secret,
